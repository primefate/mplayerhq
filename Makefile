...
SRCS_MPLAYER-$(WASAPI)        += libao2/ao_wasapi.c
...
ifeq ($(strip $(FFMPEG_A)),no)
LDFLAGS   += -L$(FFMPEG_LIB)
FFMPEG_SO := $(wildcard $(FFMPEG_LIB)/lib*.dll.a)
LDLIBS    += $(addprefix -l,$(FFMPEG_SO:$(FFMPEG_LIB)/lib%.a=%))
endif
